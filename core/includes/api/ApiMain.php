...
class ApiMain extends ApiBase {
	 ...
	 */
	public function setupExternalResponse( $module, $params ) {
	 ...
	 * @param bool $isError
	 */
	public function printResult( $isError ) {
	...
	public function setInternalMode( $mode = false ) {
		$this->mInternalMode = $mode;
	}
}
