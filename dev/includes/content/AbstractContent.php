...
// 	) {
// 		return $this->getParserOutput($title, $revId, $options, $generateHtml, null);
// 	}
	 ...
	 */
	public function getParserOutput( Title $title, $revId = null,
		ParserOptions $options = null, $generateHtml = true, Revision $revOrig = null
	) {
		if ( $options === null ) {
		...
		if ( wfRunHooks( 'ContentGetParserOutput',
			...
			$this->fillParserOutput( $title, $revId, $options, $generateHtml, $po, $revOrig);
		}
