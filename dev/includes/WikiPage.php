...
class WikiPage implements Page, IDBAccessObject {
	 ...
	 */
	public function setLastEdit( Revision $revision ) {
	...
	public function getParserOutput( ParserOptions $parserOptions, $oldid = null ) {
		...
		$useParserCache = false; //$this->isParserCacheUsed( $parserOptions, $oldid );
		...
		$pool = new PoolWorkArticleView( $this, $parserOptions, $oldid, $useParserCache, $this->mLastRevision);
		$pool->execute();
...
class PoolWorkArticleView extends PoolCounterWork {
	...
	public function __construct( Page $page, ParserOptions $parserOptions,
		$revid, $useParserCache, Revision $revOrig = null, $content = null
	) {
